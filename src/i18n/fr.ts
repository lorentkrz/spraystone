export const fr = {
  ...
  steps: {
    ...
    finish: {
      ...
      options: {
        'natural-stone': {
          title: 'Pierre de France',
          subtitle: 'Pierre beige chaude avec joints nets.',
          bestFor: 'Facades classiques & renovations',
        },
        smooth: {
          title: 'Pierre de gres beige/brun',
          subtitle: 'Gres beige/brun au grain subtil.',
          bestFor: 'Exterieurs chaleureux & rustiques',
        },
        textured: {
          title: 'Pierre de gres claire',
          subtitle: 'Gres clair avec variations douces.',
          bestFor: 'Facades lumineuses & elegantes',
        },
        'gris-bleue': {
          title: 'Pierre gris bleue',
          subtitle: 'Pierre bleu-gris avec tons mineraux froids.',
          bestFor: 'Facades modernes',
        },
        'gris-bleue-nuancee': {
          title: 'Pierre gris bleue nuancee',
          subtitle: 'Texture bleu-gris nuancee avec variation naturelle.',
          bestFor: 'Rendu premium personnalise',
        },
        brick: {
          title: 'Brique rouge',
          subtitle: 'Finition brique rouge aux joints marques.',
          bestFor: 'Maisons en brique traditionnelles',
        },
        other: {
          title: 'Autre',
          subtitle: 'Finition neutre personnalisee pour facades mixtes.',
          bestFor: 'Projets sur mesure',
        },
        suggest: {
          title: 'Je ne suis pas sur (suggestion atelier)',
          subtitle: 'Laissez notre atelier vous proposer 3 moodboards.',
          bestFor: 'Reponse rapide avec l aide d un expert',
        },
      },
    },
    photo: {
  ...
  results: {
    ...
    investment: {
      ...
      subtitle: 'Estimation basée sur la finition et la surface.',
      toggleTotal: 'Prix total (TVAC)',
      toggleFinancing: 'Financement',
      totalCaption: 'Estimation totale du projet',
      installmentCaption: 'Mensualité estimée',
      monthlyTitle: 'Mensualité estimée',
      monthlyCaption: 'pour {months} mois',
      pricePerM2Label: 'Prix par m²',
      surfaceLabel: 'Surface',
      surfaceEstimated: 'Estimé {surface}',
      htSuffix: 'HT',
      perMonth: '/ mois',
      ...
      adjustSurfaceLabel: 'Surface (m\u00B2)',
      durationLabel: 'Choisir la durée (mois)',
      legalMaxSummary:
    ...
    texture: {
      ...
      options: {
        'natural-stone': 'Pierre de France',
        smooth: 'Pierre de gres beige/brun',
        textured: 'Pierre de gres claire',
        'gris-bleue': 'Pierre gris bleue',
        'gris-bleue-nuancee': 'Pierre gris bleue nuancee',
        brick: 'Brique rouge',
        other: 'Autre',
        suggest: 'Suggestion',
      },
